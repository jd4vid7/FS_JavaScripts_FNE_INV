...
try{
    ...
    if(IDTRAMITE.GetValue() !== null){
        ...
        let blankSpace2 = document.getElementById("IDDOCUMENTOBORRADOR_lnkDescripcion_");
        ...
        cambiarEstiloCtrls([IDCLASETRAMITE_EXTENDBTN, FECHARADICADOENTRADA_EXTENDBTN, IDTIPOTRAMITE_EXTENDBTN, IDENTIDAD_EXTENDBTN, IDTRAMITEMODIFICADO_ExpandirBtn], "display", "none");
...
try{
    ...
    IDTRAMITEMODIFICADO_ExpandirBtn.style.display = 'none';
